...
# initialize measure group vectors
...
mchoices <- c("Received Help", "Clean Bathroom", "Staff Communicated Well", "Pain Control", "Meds Explained", 
              "Quiet Room", "Given Information", "Understood Care", "Hospital Rating", "Recommend Hospital")
